...
Today, I started exploring the basics of Python programming, understanding how Python works, and writing my first simple programs.
...
* Using the Python interpreter (IDLE / VS Code)
* Basic syntax 
...
2. Converting input data types (int(), float(), str())
3. Understanding string basics
4. String slicing and indexing
5. Common string functions (upper(), lower(), title   g(),  strip(), replace())
